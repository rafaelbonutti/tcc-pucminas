package br.pucminas.professor.rest;
...
public class ProfessorEndpoint {
	...
	public Response listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Long> countAllQuery = em.createQuery(
				"SELECT COUNT (DISTINCT p) FROM Professor p",
				Long.class);
		
		Long count = countAllQuery.getSingleResult();
